...
const elementSent = (element) => element('probe', false).sent();

function createGeminiPageStub({ settings, calls, elements, incrementWait, currentWaits }) {
  return {
    async goto(received) {
